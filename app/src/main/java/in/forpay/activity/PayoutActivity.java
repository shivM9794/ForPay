...
import in.forpay.databinding.ActivityPayoutBinding;
...
public class PayoutActivity extends AppCompatActivity implements RecyclerItemTouchHelperPayout.RecyclerItemTouchHelperListener {
...
//                                initUI(jsonObject.getJSONArray("fieldArray"));
                                    ...
                                    Toasty.success(PayoutActivity.this, jsonObject.getString("resText")).show();
                                    ...
                                    Utility.showToastLatest(PayoutActivity.this, jsonObject.getString("resText"), "ERROR");
