...
public class FPLActivity extends AppCompatActivity {

    private ActivityFplactivityBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_fplactivity);
        activity = this;
