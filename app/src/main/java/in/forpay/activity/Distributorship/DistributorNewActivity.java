...
import in.forpay.R;
import in.forpay.databinding.ActivityDistributorNewBinding;
...
public class DistributorNewActivity extends AppCompatActivity {

    private ActivityDistributorNewBinding binding;
...
*/
        binding = ActivityDistributorNewBinding.inflate(getLayoutInflater());
        ...
        binding.downloadButton.setOnClickListener(v -> {
            if (downloadurl != null) {
                ...
                try {
                    ...
                    try {
                        Intent intent = new Intent(DistributorNewActivity.this, WebViewActivity.class);
