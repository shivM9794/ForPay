...
public class DistributorshipAdapter extends PagerAdapter {
    Context context;
    ArrayList<GetProfileResponse.PremiumBanner> premiumBanners;
    String premiumHeader;
    LayoutInflater layoutInflater;

    public DistributorshipAdapter(Context context, String premiumHeader, ArrayList<GetProfileResponse.PremiumBanner> premiumBanners) {
