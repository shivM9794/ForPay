...
import in.forpay.databinding.ActivityFplchooseModeNewBinding;
...
public class FPLChooseModeNewActivity extends AppCompatActivity {

    private ActivityFplchooseModeNewBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(this,R.layout.activity_fplchoose_mode_new);
        activity = this;
